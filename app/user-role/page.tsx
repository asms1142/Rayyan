      ...
      columns: [
        ...
        },
        {
          ...
          cellClick: function (e, cell) {
            ...
            if (targetText === 'Module Access') router.push(`/superadmin/module-access/${data.role_id}`);
            if (targetText === 'Menu Access') router.push(`/superadmin/menu-access/${data.role_id}`);
          },
        },
      ],
    });
