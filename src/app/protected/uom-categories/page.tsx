...
export default function UOMPage() {
      ...
      columns: [
        ...
        },
        {
          ...
          formatter: (cell) => {
            ...
            if (permissions.edit) container.appendChild(editBtn);
            ...
            if (permissions.delete) container.appendChild(delBtn);
  ...
  const handleUpdate = async () => {
    ...
    if (updated && tabulator.current) tabulator.current.updateData(updated);
    resetForm();
  };
